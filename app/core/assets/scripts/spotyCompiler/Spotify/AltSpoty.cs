...
namespace Spotify
{
    public class Spotify
    {
        ...
        private static void ContollKeyboardPerssed()
        {
            ...
            var altspaceKey = hotKeyManager.Register(VirtualKeyCode.VK_SPACE, Modifiers.Alt);
            var altRightArrow = hotKeyManager.Register(VirtualKeyCode.VK_RIGHT, Modifiers.Alt);
            var altLeftArrow = hotKeyManager.Register(VirtualKeyCode.VK_LEFT, Modifiers.Alt);
            var altUpArrow = hotKeyManager.Register(VirtualKeyCode.VK_UP, Modifiers.Alt);
            var altDownArrow = hotKeyManager.Register(VirtualKeyCode.VK_DOWN, Modifiers.Alt);
        }
